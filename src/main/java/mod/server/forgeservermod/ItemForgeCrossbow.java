...
public class ItemForgeCrossbow extends CrossbowItem {
	...
	private boolean isLoadingStart = false;
	   ...
	   public ItemForgeCrossbow(Item.Properties properties) {
		   super(properties);
	   }
	   ...
	   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (isCharged(itemstack)) {
	         fireProjectiles(worldIn, playerIn, handIn, itemstack, func_220013_l(itemstack), 0.07F);
	   ...
	   private static AbstractArrowEntity createArrow(World worldIn, LivingEntity shooter, ItemStack crossbow, ItemStack ammo) {
	      ...
	      if(abstractarrowentity instanceof ArrowEntity) {
	    	  ArrowEntity newArrow = new EntityTippedArrow(worldIn, shooter);
	    	  newArrow.setPotionEffect(ammo);
	    	  abstractarrowentity = newArrow;
	      } else if(abstractarrowentity instanceof SpectralArrowEntity) {
	    	  abstractarrowentity = new EntitySpectralArrow(worldIn, shooter);
	      }
	   ...
	   private static float func_220013_l(ItemStack p_220013_0_) {
	      return p_220013_0_.getItem() == Items.CROSSBOW && hasChargedProjectile(p_220013_0_, Items.FIREWORK_ROCKET) ? 2.7F : 5.72F;
	   }
